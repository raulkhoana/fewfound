...
export const metadata: Metadata = pageMeta({
  ...
  description: 'Terms and Conditions for Few Found — India\'s trust layer for marketing service providers. Operated by Scalemind Media.',
  path: '/terms',
});
...
const SECTIONS = [
  {
    heading: null,
    body: `These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between SCALEMIND MEDIA ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
...
By using our website and availing the Services, you agree that you have read and accepted these Terms (including the Privacy Policy). We reserve the right to modify these Terms at any time and without assigning any reason. It is your responsibility to periodically review these Terms to stay informed of updates.`,
  ...
  },
  {
    ...
    body: `The contents of the Website and the Services are proprietary to Us and you will not have any authority to claim any intellectual property rights, title, or interest in its contents.`,
  },
  {
    heading: 'Unauthorized Use',
    body: `You acknowledge that unauthorized use of the Website or the Services may lead to action against you as per these Terms or applicable laws.`,
  },
  {
    heading: 'Payment',
  ...
  },
  {
    ...
    body: `You agree and acknowledge that website and the Services may contain links to other third party websites. On accessing these links, you will be governed by the terms of use, privacy policy and such other policies of such third party websites.`,
  },
  {
  ...
  },
  {
    ...
    body: `All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in South West Delhi, Delhi.`,
  },
  {
    heading: 'Contact',
    body: `All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website. You may reach us at hello@fewfound.co or via WhatsApp at +91 9810939740.`,
  },
];
...
export default function TermsPage() {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '64px 24px' }}>
      ...
      <h1 style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 36, color: '#0A0908', marginBottom: 8 }}>Terms &amp; Conditions</h1>
      ...
      <div style={{ borderTop: '1px solid #E2DED6', paddingTop: 32 }}>
        {SECTIONS.map((s, i) => (
          <div key={i} style={{ marginBottom: 28 }}>
            {s.heading && (
              <h2 style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 18, color: '#0A0908', marginBottom: 10 }}>
                {s.heading}
              </h2>
            )}
            {s.body.split('\n\n').map((para, j) => (
              <p key={j} style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", fontSize: 14, color: '#3D3B38', lineHeight: 1.8, marginBottom: 8 }}>
                {para}
              </p>
            ))}
          </div>
